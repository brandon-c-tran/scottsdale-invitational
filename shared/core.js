...
const GAMES = {
  putting: { name:"Putting", howto:{ players:"Solo", gear:["Putter","One ball"],
    ...
    win:"Long Putt: closest of three attempts. Nine-Hole: fewest total strokes.", house:"Ties go to sudden death, one putt each." } },
  ...
  basketball: { name:"Basketball", variants:[
    { id:"1v1", label:"1v1", howto:{ players:"Solo, heats then a final", gear:["Half court","One ball"],
      ...
      steps:["Check the ball up top.","Everything counts one.","Make it, take it.","First to five, win by one."],
      win:"First to five wins the game. Best record in your heat moves on.", house:"Call your own fouls." } },
    ...
    { id:"5v5", label:"5v5", howto:{ players:"Two teams of five", gear:["Full court","One ball","A clock"],
      ...
      steps:["Tip off to start.","Twos inside the arc, threes beyond it.","Clear past half on a change of possession.","Two halves, running clock."],
      win:"Ahead at the horn wins.", house:"Call your own fouls. No hard contact." } },
  ]},
  ...
  pingpong: { name:"Ping Pong", howto:{ players:"Solo", gear:["Table","Paddles","One ball"],
    ...
    steps:["Serve two, then hand it over.","Serve must clear the net and bounce once each side.","Let it bounce once on your side before returning.","Games to eleven, win by two."],
    win:"Games to eleven, win by two. Best in the final takes it.", house:"Rally for serve to start." } },
  ...
  gauntlet: { name:"The Gauntlet", howto:{ players:"Solo, on the clock", gear:["Putter","Cups","Pong ball","One die"],
    ...
    house:"One runner at a time. The room keeps time and keeps you honest." } },
};
